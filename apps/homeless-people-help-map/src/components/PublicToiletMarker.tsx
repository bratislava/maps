...
import { ReactComponent as MarkerInactiveIcon } from "../assets/icons/toilets/marker-inactive.svg";
import { ReactComponent as MarkerActiveIcon } from "../assets/icons/toilets/marker-active.svg";

export interface IPublicToiletMarkerProps {
...
export const PublicToiletMarker = ({
  feature,
  onClick,
  isSelected = false,
  count,
}: IPublicToiletMarkerProps) => {
