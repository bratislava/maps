...
export const environment = {
  ...
  mapboxPublicToken: assertEnv(
    "PUBLIC_MAPBOX_PUBLIC_TOKEN",
    process.env.PUBLIC_MAPBOX_PUBLIC_TOKEN,
  ),
  ...
  mapboxLayerPrefix: assertEnv(
    "PUBLIC_MAPBOX_LAYER_PREFIX",
    process.env.PUBLIC_MAPBOX_LAYER_PREFIX,
  ),
