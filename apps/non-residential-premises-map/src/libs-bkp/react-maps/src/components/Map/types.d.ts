import { LngLat, MapboxGesturesOptions, Padding, PartialViewport, Viewport } from '@bratislava/react-mapbox';
...
export interface MapMethods {
    changeViewport: (wantedViewport: PartialViewport, duration?: number) => void | undefined;
    fitDistrict: (district: string | string[]) => void;
    fitBounds: (bounds: mapboxgl.LngLatBoundsLike, options?: mapboxgl.FitBoundsOptions) => void;
    fitFeature: (features: Feature | Feature[], options?: {
        padding?: number;
    }) => void;
    moveToFeatures: (features: Feature | Feature[], options?: {
        zoom?: number;
    }) => void;
