export default {
  ...
  detail: {
    ...
    tags: "Športy",
    navigate: "Navigovať",
    wantToWorkout: "Chcem cvičiť",
    sportGround: "Športovisko",
    email: "Email",
  },
  // for libraries
  ...
  informationModal: {
    ...
    description:
      "Mapa cvičiek, nových workoutových ihrísk a bežeckých trás pre všetky aktívne Bratislavčanky a Bratislavčanov. Cvičká vznikli v spolupráci s nadáciou ČSOB.",
