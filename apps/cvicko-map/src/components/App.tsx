...
export const App = () => {
  ...
  const [selectedFeatures, setSelectedFeatures] = useState<MapboxGeoJSONFeature[] | null>(null);
  ...
  useEffect(() => {
    districtFilter.activeKeys.length == 1
      ? mapRef.current?.fitDistrict(districtFilter.activeKeys[0])
  ...
  return isLoading ? null : (
    <Map
      ...
      onFeaturesClick={setSelectedFeatures}
